...
import '../theme/cleo_design_system.dart';
import '../theme/socelle_colors.dart';

/// Side drawer — reflects the 5-tab shell layout.
///
/// Tabs 0–1 and 4 (Feed, Discover, Profile) use Cleo accent color.
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            ...
            // ── Intelligence tabs (Cleo) ──
            _DrawerTile(
              icon: Icons.rss_feed_outlined,
              label: 'Feed',
              selected: currentIndex == 0,
              selectedColor: CleoColors.primaryCocoa,
