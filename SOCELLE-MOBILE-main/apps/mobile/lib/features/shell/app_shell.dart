...
///
/// Tab layout:
///   0 · Feed     (CleoTheme — intelligence surface)
///   1 · Discover (CleoTheme — brands/events/education)
///   2 · Revenue  (SocelleTheme — gap-recovery, DO NOT CHANGE)
///   3 · Schedule (SocelleTheme — gap-recovery, DO NOT CHANGE)
///   4 · Profile  (CleoTheme — practice profile + settings)
///
/// The bottom bar remains flat, borderless, and editorial. Active item color
/// adapts per tab theme: CleoColors.primaryCocoa for Cleo tabs (0, 1, 4),
...
class AppShell extends ConsumerWidget {
  ...
  /// Returns true for tabs that use CleoTheme (Feed, Discover, Profile).
  static bool _isCleoTab(int index) =>
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final activeColor = _isCleoTab(safeIndex)
        ? CleoColors.primaryCocoa
        : SocelleColors.ink;
    final inactiveColor = _isCleoTab(safeIndex)
