    ...
    return CleoScaffold(
      body: SafeArea(
        child: RefreshIndicator(
          ...
          backgroundColor: CleoColors.bgNearWhite,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('$label Coming Soon', style: CleoText.headlineMedium),
              const SizedBox(height: 8),
              const Text(
...
class _EducationCard extends StatelessWidget {
  ...
  ({String label, Color color}) _typeMeta(String type) => switch (type) {
        'ce_course' => (label: 'CE Course', color: CleoColors.green400),
        'webinar' => (label: 'Webinar', color: CleoColors.teal400),
        'video' => (label: 'Video', color: CleoColors.blue400),
        'protocol' => (label: 'Protocol', color: CleoColors.orange400),
        _ => (label: 'Article', color: CleoColors.purple400),
      };
              ...
              AspectRatio(
                ...
                child: Image.network(
                  ...
                  errorBuilder: (_, __, ___) =>
                      Container(color: CleoColors.bgAlt),
                ),
              ),
                    ...
                    children: [
                      ...
                      if (item.isCeEligible) ...[
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: CleoColors.green400.withValues(alpha: 0.12),
                            borderRadius: BorderRadius.circular(6),
                          ),
                          child: Text(
                            item.ceCredits != null
                    ...
                    children: [
                      if (item.difficulty != null) ...[
                        Text(
                          ...
                          style: CleoText.bodyMedium.copyWith(fontSize: 12),
                        ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 14,
                    decoration: BoxDecoration(
                      color: CleoColors.neutralBeige.withValues(alpha: 0.25),
    ...
    return SliverToBoxAdapter(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const CleoSectionLabel('Sponsored'),
            const SizedBox(height: 12),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(message, style: CleoText.headlineMedium),
            const SizedBox(height: 8),
            const Text(
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(icon, size: 48, color: CleoColors.neutralBeige),
            const SizedBox(height: 16),
            Text(message, style: CleoText.headlineMedium),
            const SizedBox(height: 8),
            Text(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                CleoColors.neutralBeige.withValues(alpha: 0.25),
                            borderRadius: BorderRadius.circular(6),
                          ),
                        ),
                        const SizedBox(height: 8),
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                CleoColors.neutralBeige.withValues(alpha: 0.15),
                            borderRadius: BorderRadius.circular(5),
                          ),
                        ),
                      ],
...
class _BrandInitials extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Text(
        _initials,
        style: CleoText.headlineMedium.copyWith(fontWeight: FontWeight.w700),
      ),
    );
  }
}
...
class _EventCard extends StatelessWidget {
  ...
  ({String label, Color color}) _typeMeta(String type) => switch (type) {
        'conference' => (label: 'Conference', color: CleoColors.blue400),
        'training' => (label: 'Training', color: CleoColors.green400),
        'webinar' => (label: 'Webinar', color: CleoColors.teal400),
        'summit' => (label: 'Summit', color: CleoColors.orange400),
        'tradeshow' => (label: 'Trade Show', color: CleoColors.yellow400),
        'brand_education' => (label: 'Brand Ed', color: CleoColors.purple400),
        'retreat' => (label: 'Retreat', color: CleoColors.orange700),
        'networking' => (label: 'Networking', color: CleoColors.neutralBeige),
        _ => (label: type, color: CleoColors.neutralBeige),
      };
...
class _IconRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final text = Text(
      label,
      style: CleoText.bodyMedium.copyWith(fontSize: 13),
      overflow: expand ? TextOverflow.ellipsis : null,
    );
    return Row(
      children: [
        Icon(icon, size: 13, color: CleoColors.neutralBeige),
