              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 10,
                    decoration: BoxDecoration(
                      color: CleoColors.neutralBeige.withValues(alpha: 0.10),
                      borderRadius: BorderRadius.circular(5),
                    ),
                  ),
                ],
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            const Text('Could not load feed', style: CleoText.headlineMedium),
            const SizedBox(height: 8),
            const Text(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text('No signals yet', style: CleoText.headlineMedium),
            SizedBox(height: 8),
            Text(
                          ...
                          if (item.brandMention != null)
                            Expanded(
                              child: Text(
                                item.brandMention!,
                                style:
                                    CleoText.bodyMedium.copyWith(fontSize: 12),
                      ...
                      if (item.tags.isNotEmpty) ...[
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: CleoText.bodyMedium.copyWith(fontSize: 11),
                            overflow: TextOverflow.ellipsis,
                          ),
                        ),
                      ] else
