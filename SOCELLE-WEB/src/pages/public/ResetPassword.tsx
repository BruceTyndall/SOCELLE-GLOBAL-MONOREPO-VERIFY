        ...
        <div className="bg-white rounded-lg shadow-sm p-8 border border-pro-stone">
          ...
          {checkingSession && (
             <div className="mb-6 flex justify-center">
               <div className="w-6 h-6 border-2 border-pro-navy border-t-transparent rounded-full animate-spin" />
             </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="newPassword" className="block text-sm font-medium text-pro-charcoal mb-2">
                Password
              </label>
              <input
                id="newPassword"
                ...
                required
                disabled={!hasSession}
                className="w-full px-4 py-2 border border-pro-stone rounded-lg focus:ring-2 focus:ring-pro-navy focus:border-pro-navy disabled:bg-pro-stone"
                placeholder="••••••••"
              />
            </div>

            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-pro-charcoal mb-2">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
