...
/* ━━ 6. Live Data UI Integrator ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Real-time confidence tiers, fresh timestamps, avoiding fake signals.
   Mocked here but structured for real API integration. */
const INTELLIGENCE_SIGNALS = [
  { id: '1', label: 'Polynucleotides', value: '+42%', trend: 'up', confidence: 'High', updated: '2m ago', insight: 'Overtaking exosome demand in Tier 1 cities.' },
  { id: '2', label: 'Average Cart Value', value: '$1,294', trend: 'up', confidence: 'Verified', updated: 'Real-time', insight: 'Top quartile operators up 18% YoY.' },
  { id: '3', label: 'Aggressive Peels', value: '-12%', trend: 'down', confidence: 'Moderate', updated: '1h ago', insight: 'Shifting towards energy-based devices.' },
  { id: '4', label: 'Barrier Repair', value: '+88%', trend: 'up', confidence: 'High', updated: '12m ago', insight: 'Dominating post-treatment protocols.' },
];
      ...
      <section className="relative py-24 lg:py-32 bg-[var(--bg-page-main)]">
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {INTELLIGENCE_SIGNALS.map((signal, idx) => (
